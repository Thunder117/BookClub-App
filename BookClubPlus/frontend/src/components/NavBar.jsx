                ...
                { user 
                    ...
                    <div className="items-center h-full flex flex-row lg:gap-4">
                        ...
                        <div className={`relative h-full`}>
                            ...
                            <div className={`bg-white rounded-md min-w-[160px] top-[105%] right-0 lg:left-0 text-black absolute drop-shadow-lg ${!userDropdown && 'hidden'}`}>
                                
                                <button onClick={handleClick} className={`px-6 py-2 block`}>
                                    Sign Out
                                </button>
