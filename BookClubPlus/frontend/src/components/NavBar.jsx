            ...
            <div className="flex basis-2/3 w-full items-center pl-5 lg:pl-40 gap-4 lg:gap-8">
                ...
                { user && (
                    <div className="items-center h-full flex flex-row lg:gap-8">
                        <span className={`transition ${(props.showNav && "text-black")} ${(window.innerWidth < 992) && 'hidden'}`}>{user.username}</span>

                        <div className={`relative h-full w-full ${(window.innerWidth > 992) && 'hidden'}`}>
                        ...
                        <button onClick={handleClick} className={`w-24 rounded-md border-2 border-green-700 transition duration-500 ${(props.showNav) && "text-gray-700"} ${(window.innerWidth < 992) && 'hidden'}`}>
                            Log Out
                        </button>
                    </div>
                )}
